...
while IFS= read -r package; do
    ...
    # Verifică dacă response-ul conține rezultate cu numele exact al pachetului
...
# Generează raportul
{
    ...
    echo
    echo "=== PACHETE CARE NECESITĂ VERIFICARE MANUALĂ ==="
    echo "Pentru pachete nevalide, verificați:"
    echo "1. Redenumite: 'package-name' -> 'package_name' sau invers"
    echo "2. Mutate în AUR: https://aur.archlinux.org/"
    echo "3. Eliminate/deprecated din repository-uri oficiale"
    echo "4. Înlocuite cu alte pachete similare"
    echo "5. Erori de scriere în lista originală"
} > "$REPORT"
